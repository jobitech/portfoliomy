    ...
    <>
      ...
      >
        ...
        <div className="max-w-3xl relative z-20 text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-fit justify-start animate-fade-in-up" style={{animation: 'fadeInUp 0.8s ease-out 0.6s forwards', opacity: 0}}>
